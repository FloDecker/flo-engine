...
public:
	...
	void calculate_view_from_transform(glm::mat4 cameraTransform, glm::vec3 cameraPos, glm::vec3 cameraViewDirection);
	void calculate_view(glm::vec3 cameraPos, glm::vec3 cameraViewDirection);
