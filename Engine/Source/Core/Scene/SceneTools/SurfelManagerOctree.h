...
private:
	...
	*/
	...
	void sync_buffers() const; //0 -> SYNC BUFFERS
	void generate_surfels_via_compute_shader() const; //1 -> INSERT SURFELS
	void find_best_world_positions_to_update_lighting() const; //2 -> FIND UPDATE POSITIONS
