...
void Scene::init_surfel_manager(Camera3D* camera_target, const framebuffer_object* surfel_framebuffer)
{
	surfel_manager_ = new SurfelManagerOctree(this);
	surfel_manager_->register_scene_data(camera_target, surfel_framebuffer);
}
