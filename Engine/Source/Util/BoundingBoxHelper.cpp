...
void BoundingBoxHelper::get_bounding_box_from_vertex_arrays(StructBoundingBox* bb, struct_vertex_array* vertex_array,
    glm::mat4x4 transformation_matrix)
{
    bb->min = vertex_array->vertices->at(0).position;
    bb->max = vertex_array->vertices->at(0).position;
